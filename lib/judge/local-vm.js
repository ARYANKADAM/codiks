 ...
 * runJudge0() in judge0.js before this is ever exposed to the public
...
export async function runLocalJavaScript({ code, functionName, testCases }) {
  ...
  // A deliberately bare sandbox — no require, no process, no fs, no
  // network globals. Only what's needed to run typical algorithm code.
